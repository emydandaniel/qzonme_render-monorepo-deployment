...
const QuizCreation: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    console.log('🔍 QuizEditor: Component mounted, checking sessionStorage...');
    console.log('🔍 QuizEditor: autoCreateMode =', autoCreateMode);
    console.log('🔍 QuizEditor: requiresReview =', requiresReviewFlag);
    console.log('🔍 QuizEditor: hasGeneratedQuestions =', hasGeneratedQuestions);
    console.log('🔍 QuizEditor: All sessionStorage keys:', Object.keys(sessionStorage));
    console.log('🔍 QuizEditor: generatedQuestions exists:', !!sessionStorage.getItem('generatedQuestions'));
    console.log('🔍 QuizEditor: generationMetadata exists:', !!sessionStorage.getItem('generationMetadata'));
    ...
    if (!shouldActivateAutoCreate && (autoCreateMode || requiresReviewFlag)) {
      ...
      console.log('🧹 Clearing stale auto-create flags - conditions not met');
      ...
      if (questions.length > 0 && isAutoGenerated) {
        console.log('🧹 Clearing auto-generated questions from state');
        setQuestions([]);
  ...
  React.useEffect(() => {
    console.log('🔍 QuizEditor: Component mounted, checking for auto-generated questions...');
    console.log('🔍 QuizEditor: isAutoCreateMode =', isAutoCreateMode);
    console.log('🔍 QuizEditor: requiresReview =', requiresReview);
    ...
    console.log('🔍 QuizEditor: generatedQuestions exists =', !!generatedQuestions);
    console.log('🔍 QuizEditor: generationMetadata exists =', !!generationMetadata);
    
    // Only activate auto-review if BOTH auto-create mode is true AND generated questions exist
    if (isAutoCreateMode && requiresReview && generatedQuestions) {
      try {

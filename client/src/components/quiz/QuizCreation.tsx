...
import { Image, Loader2, Upload, X, Clock, AlertCircle } from "lucide-react";
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <Alert className="mb-4 bg-amber-50 text-amber-800 border-amber-200">
            ...
            <AlertDescription>
              This quiz will automatically expire after 30 days. After expiration, the quiz and all responses will be permanently deleted.
            </AlertDescription>
          </Alert>
